  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Zarządzaj zespołem detailerów i pracowników myjni. Ewidencja czasu pracy, grafik, widok na żywo dla hali. Przypisywanie do stanowisk i zleceń."
      );
    }
    document.title = "Zarządzanie Zespołem w Myjni i Detailingu – Grafik i Ewidencja Czasu | N2Wash";
  }, []);
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="bg-card rounded-xl p-6 border border-border text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Ręczna ewidencja</h3>
              ...
              <div className="bg-card rounded-xl p-6 border border-border text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Chaos w grafiku</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-card rounded-xl p-6 border border-border text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Kto robi co?</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-card rounded-xl p-6 border border-border text-center">
                ...
                <h3 className="font-semibold text-foreground mb-2">Brak raportów</h3>
                <p className="text-sm text-muted-foreground">
