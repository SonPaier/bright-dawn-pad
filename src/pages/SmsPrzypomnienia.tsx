...
import { ArrowLeft, MessageSquare, Bell, Check, Car, Sparkles, BarChart3, TrendingUp, Package, ChevronRight, AlertTriangle } from "lucide-react";
        ...
        <section className="bg-gradient-to-br from-primary via-primary/90 to-sky-900 text-white py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="flex items-center gap-2 text-white/60 text-sm mb-4">
              ...
              <span className="text-white">SMS przypomnienia</span>
            </div>
