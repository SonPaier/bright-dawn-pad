...
import { ArrowLeft, BarChart3, TrendingUp, Calendar, Users, DollarSign, PieChart, Target, ChevronRight, Lightbulb } from "lucide-react";
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Raporty sprzedaży, analityka rezerwacji, statystyki pracowników. Które usługi się najlepiej sprzedają? Kiedy są szczyty? Podejmuj decyzje w oparciu o dane."
      );
    }
    document.title = "Analityka i Raporty dla Myjni i Detailingu – Dane Do Lepszych Decyzji | N2Wash";
  }, []);
        ...
        <section className="bg-gradient-to-br from-primary via-primary/90 to-sky-900 text-white py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="flex items-center gap-2 text-white/60 text-sm mb-4">
              ...
              <span className="text-white">Analityka i raporty</span>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-card rounded-2xl p-6 border border-border text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Identyfikuj trendy</h3>
              ...
              <div className="bg-card rounded-2xl p-6 border border-border text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Optymalizuj ofertę</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-card rounded-2xl p-6 border border-border text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Zwiększaj przychody</h3>
                <p className="text-sm text-muted-foreground">
        ...
        <section className="py-16 md:py-20 border-b border-border">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <Link 
                to="/crm/crm-dla-myjni-samochodowych"
                className="bg-card rounded-xl p-6 border border-border hover:border-primary/50 transition-colors group"
              >
                <BarChart3 className="w-8 h-8 text-primary mb-3" />
                <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors">CRM dla myjni</h3>
