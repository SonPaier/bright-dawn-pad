...
import { ArrowLeft, FileText, Layers, Link2, Mail, Eye, Palette, Globe, ChevronRight, CheckCircle, Clock } from "lucide-react";
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Kreator ofert dla studia detailingu. Warianty cenowe, dodatki, publiczny link dla klienta, automatyczna wysyłka email. Zwiększ skuteczność dzięki profesjonalnym ofertom."
      );
    }
    document.title = "Generator Ofert Detailingowych – Twórz Profesjonalne Wyceny w 5 Minut | N2Wash";
  }, []);
        ...
        <section className="bg-gradient-to-br from-primary via-primary/90 to-sky-900 text-white py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="flex items-center gap-2 text-white/60 text-sm mb-4">
              ...
              <span className="text-white">Generator ofert</span>
            </div>
        ...
        <section className="py-16 md:py-20 border-b border-border">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Link 
                to="/funkcje/protokol-przyjecia-pojazdu"
