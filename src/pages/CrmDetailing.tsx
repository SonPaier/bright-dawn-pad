...
import { ArrowLeft, FileText, Camera, Bell, TrendingUp, Palette, Shield, Clock, CheckCircle } from "lucide-react";
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                className="h-12 px-8 text-base font-semibold rounded-xl border-white/30 text-white hover:bg-white/10"
              >
                <Link to="/cennik-crm-myjnia-detailing">Zobacz pełny cennik</Link>
              </Button>
            </div>
          </div>
        </section>
