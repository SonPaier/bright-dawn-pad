...
const OpiniePage = () => {
  useEffect(() => {
    document.title = "Opinie Klientów N2Wash – Co Mówią Właściciele Myjni i Studiów Detailingu";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Przeczytaj opinie właścicieli myjni i studiów detailingu o systemie N2Wash. Prawdziwe case studies, wyniki, referencje."
      );
    }
  }, []);
