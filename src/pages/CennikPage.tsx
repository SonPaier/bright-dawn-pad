...
const CennikPage = () => {
  useEffect(() => {
    document.title = "Cennik – Przejrzyste Plany dla Myjni i Detailingu | N2Wash";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Cennik CRM N2Wash: Myjnia od 129 zł/msc, Detailing od 199 zł/msc. Bez ukrytych kosztów. 7 dni za darmo. Bezpłatna migracja danych."
      );
    }
  }, []);
