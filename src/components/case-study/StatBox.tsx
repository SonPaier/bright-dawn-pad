...
const StatBox = ({ 
  ...
  const sizeStyles = {
    ...
    lg: { value: "text-4xl md:text-5xl", label: "text-base", padding: "p-6 md:p-8" },
  };
  ...
  return (
    ...
    >
      ...
      <p className={cn("text-muted-foreground mt-1", sizeStyles[size].label)}>
        {label}
      </p>
      {sublabel && (
        <p className={cn("text-muted-foreground/70 mt-0.5", sizeStyles[size].label)}>
          {sublabel}
        </p>
      )}
    </div>
